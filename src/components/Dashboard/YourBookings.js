...
//   return (
//     <Box sx={{ py: 2, ml: 3 }} id="bookings">

//       <Typography sx={{ fontWeight: 'bold',fontSize:"13px" }}>YOUR BOOKINGS</Typography>
//       <Card sx={{ mt: 1 }} id= "card-booking">
//         <Box>
//           <Box style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
//             <Box style={{ display: 'flex', flexDirection: 'row' }}>
//               <Box style={{ marginLeft: "5px" }} >
//                 <Box sx={lineStyle1} />
//                 <Typography variant="h6" style={{ fontSize: "12px", marginLeft: "15px", marginTop: "5px" }}>Your Bookings</Typography>
...
const YourBookings = () => {
  ...
  const bookingsData = {
    ...
    totalbookinng: 198,
    past15daysyour: [
      { count: 4 }, { count: 6 }, { count: 5 }, { count: 7 }, { count: 4 },
      { count: 5 }, { count: 8 }, { count: 5 }, { count: 6 }, { count: 7 },
      { count: 5 }, { count: 4 }, { count: 6 }, { count: 5 }, { count: 3 }
    ],
    past15daystotal: [
      { count: 12 }, { count: 14 }, { count: 13 }, { count: 16 }, { count: 12 },
      { count: 15 }, { count: 17 }, { count: 13 }, { count: 14 }, { count: 16 },
      { count: 13 }, { count: 12 }, { count: 14 }, { count: 13 }, { count: 11 }
    ]
  };
