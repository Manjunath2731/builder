...
const BrokerVisits = () => {
  ...
  return (
    <Box sx={{ py: 2}} id="bookings">
      ...
      <Typography sx={{ fontWeight: 'bold', fontSize: "13px" }}>BROKER MEETINGS</Typography>
      <Card sx={{ mt: 1 }} id="Vipcard">
          <Box  style={{ display: 'flex', flexDirection: 'row' }}>
            <Box  py={4}>
              <Box >
            <Typography sx={{ fontSize: "13px",fontWeight: 700,textAlign: 'center', color: "#E27020"}}> Today's Meetings</Typography>

            <Box px={6} style={{ display: 'flex' ,alignItems: 'center', flexDirection: 'column'}}>
              <Typography sx={{ fontSize: "22px", fontWeight: "bold", color: "#E16C19", mt: 3.5 }}> 3456</Typography>
