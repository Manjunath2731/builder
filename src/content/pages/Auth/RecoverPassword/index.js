...
import {sendNewPassword} from '../../../../axiosInstances/Api';
    ...
    <>
      ...
      <MainContent>
        <Container maxWidth="sm">
          ...
          {/* <img
            src={require('../../../../assets/builderImage/builder_logo.png')}
            alt="imagess"
          /> */}
          ...
          >
            ...
            <Formik
              ...
              onSubmit={async (
                ...
                try {
                  const resetPasswordResponce = sendNewPassword(values.email);
                  handleOpenDialog();
                  console.log('reset: ', resetPasswordResponce);
                } catch (error) {
